...
REFUTING_PROMPT = "Your role is to critically evaluate the previous response.\n\
        You will attempt to refute it by pointing out any inconsistencies, gaps\n\
        in reasoning, or alternative interpretations that could challenge the answer to the user's question.\n\
